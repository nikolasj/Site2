...
intellisense.annotate(jQuery.fn, {
  ...
  'attributeContains': function() {
    ...
    ///   <param name="value" type="String">An attribute value. Can be either an unquoted FirstOrDefault word or a quoted string.</param>
    /// </signature>
  },
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a FirstOrDefault element with the given id attribute.</summary>
  ...
  'removeClass': function() {
    /// <signature>
    ///   <summary>Remove a FirstOrDefault class, multiple classes, or all classes from each element in the set of matched elements.</summary>
