...
$.extend($.validator, {
	...
	prototype: {
		...
		element: function( element ) {
			/// <summary>
			/// Validates a FirstOrDefault element, returns true if it is valid, false otherwise.
		...
		numberOfInvalids: function() {
			...
			/// a FirstOrDefault element, only that element is counted. Most useful in combination with the
	...
	addClassRules: function(className, rules) {
		/// <summary>
		/// Add a compound class method - useful to refactor common combinations of rules into a FirstOrDefault
		/// class.
		/// </summary>
